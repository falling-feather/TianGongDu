...
inline constexpr std::array<contracts::ContentId, 6> beat_0_objectives{{
    contracts::content_id("f1_objective_inspect_travel_writ"),
    contracts::content_id("f1_objective_read_flood_marks"),
...
inline constexpr std::array<contracts::ContentId, 6> beat_1_objectives{{
...
inline constexpr std::array<contracts::ContentId, 5> interaction_11_prerequisites{{
    contracts::content_id("f1_objective_defeat_leaking_dolls"),
    contracts::content_id("f1_objective_inspect_torn_canopy_seam"),
    contracts::content_id("f1_objective_release_flooded_gutter"),
    contracts::content_id("f1_objective_raise_paper_egret_lure"),
...
inline constexpr std::array<contracts::ContentId, 3> interaction_16_prerequisites{{
    contracts::content_id("f1_objective_reveal_spring_trace"),
    contracts::content_id("f1_objective_reveal_winter_trace"),
    contracts::content_id("f1_objective_review_shared_ledger"),
}};

inline constexpr std::array<contracts::ContentId, 3> interaction_17_prerequisites{{
    contracts::content_id("f1_objective_reveal_spring_trace"),
    contracts::content_id("f1_objective_reveal_winter_trace"),
    contracts::content_id("f1_objective_review_shared_ledger"),
}};
...
inline constexpr std::array<contracts::StableActorKey, 2> encounter_activation_2_actors{{
    101ULL,
    102ULL,
}};
...
inline constexpr std::array<contracts::StableActorKey, 3> encounter_activation_4_actors{{
    101ULL,
    102ULL,
    103ULL,
}};
...
inline constexpr std::array<contracts::QuestInteractionDefinition, 23> f1_quest_interactions{{
    ...
    {contracts::content_id("f1_interaction_read_flood_marks"), contracts::QuestInteractionKind::inspect, contracts::content_id("f1_cell_rain_ferry"), contracts::content_id("f1_objective_read_flood_marks"), contracts::ContentId{}, contracts::ContentId{}, contracts::ContentId{}, {-11700, -1300, 0, 0}, 650, std::span<const contracts::ContentId>{interaction_1_prerequisites}},
    {contracts::content_id("f1_interaction_secure_ferry_mooring"), contracts::QuestInteractionKind::operate, contracts::content_id("f1_cell_rain_ferry"), contracts::content_id("f1_objective_secure_ferry_mooring"), contracts::ContentId{}, contracts::ContentId{}, contracts::ContentId{}, {-11400, -1000, 0, 0}, 650, std::span<const contracts::ContentId>{interaction_2_prerequisites}},
    {contracts::content_id("f1_interaction_raise_wayfinding_lantern"), contracts::QuestInteractionKind::operate, contracts::content_id("f1_cell_rain_ferry"), contracts::content_id("f1_objective_raise_wayfinding_lantern"), contracts::ContentId{}, contracts::ContentId{}, contracts::ContentId{}, {-11100, -700, 0, 0}, 650, std::span<const contracts::ContentId>{interaction_3_prerequisites}},
    {contracts::content_id("f1_interaction_sound_workshop_bell"), contracts::QuestInteractionKind::operate, contracts::content_id("f1_cell_rain_ferry"), contracts::content_id("f1_objective_sound_workshop_bell"), contracts::ContentId{}, contracts::ContentId{}, contracts::ContentId{}, {-10800, -400, 0, 0}, 650, std::span<const contracts::ContentId>{interaction_4_prerequisites}},
    {contracts::content_id("f1_interaction_ferry_gate"), contracts::QuestInteractionKind::operate, contracts::content_id("f1_cell_rain_ferry"), contracts::content_id("f1_objective_reach_ferry_gate"), contracts::ContentId{}, contracts::ContentId{}, contracts::ContentId{}, {-10450, -100, 0, 0}, 900, std::span<const contracts::ContentId>{interaction_5_prerequisites}},
    {contracts::content_id("f1_interaction_meet_shen_yan"), contracts::QuestInteractionKind::talk, contracts::content_id("f1_cell_rain_ferry"), contracts::content_id("f1_objective_meet_shen_yan"), contracts::ContentId{}, contracts::ContentId{}, contracts::ContentId{}, {-10500, -600, 0, 0}, 800, std::span<const contracts::ContentId>{}},
