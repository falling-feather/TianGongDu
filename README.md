...
> 最后更新：2026-07-05  
> 维护者：项目维护者  
> 关联文档：`doc/README.md`、`doc/01_开发者手册.md`、`doc/02_项目规划与验收.md`、`doc/03_项目全局设计规划.md`、`doc/13_江南区域新版大地图设计方案.md`、`doc/12_测试与验收指南.md`、`CHANGELOG.md`
...
- 江南新版 5 小时四维大地图扩展方案见 `doc/13_江南区域新版大地图设计方案.md`。
