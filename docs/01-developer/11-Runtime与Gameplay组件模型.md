...
当前根 F1 schema/generated 仍为 1.4 空 cue，因此本节是 **Bootstrap Implemented / Dormant For Current F1 Content**。实际 1.6 cue/evidence 内容、Interaction/Combat/Recovery raw-result emitter、两路线固定 checksum、10 个 Stable Asset ID resolver、训练安全点 Encounter+Session+Combat 重建、浏览器焦点/200%/路线证据及真人盲测仍未完成。
